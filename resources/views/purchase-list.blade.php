    ...
    <div class="modal fade" id="new-order" tabindex="-1" role="form" aria-hidden="true">
        ...
        <div class="container-fluid">
            <div class="row">
                            ...
                            <div class="card card-block card-stretch card-height">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4 card-total-sale">
                                        ...
                                        <div>
                                            <p class="mb-2">Toplam Ödenen TL</p>
                                            <h4>{{session('sumTL')}} ₺</h4>
                                            <br>
                                        </div>
                                    </div>
                            ...
                            <div class="card card-block card-stretch card-height">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4 card-total-sale">
                                        ...
                                        <div>
                                            <p class="mb-2">Toplam Ödenen USD</p>
                            ...
                            <div class="card card-block card-stretch card-height">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-4 card-total-sale">
                                        ...
                                        <div>
                                            <p class="mb-2">Toplam Ödenen EUR</p>
                ...
                <h4 class="card-title" >Ödenmiş Siparişler:</h4>
                <p>{{session('Log')}}</p>
